 ...
 * #color()} and color methods, to return the immutable Unicode symbol and {@link #color()} enum instance of
 * any suit.
 */
public enum Suit {
  ...
  /**
   * Returns Unicode plaing card symbol for this suit.
   *
  ...
  /**
   * Encapsulates the two possible colors( red &amp; black) of playing cards suit.
   */
  public enum Color {
    RED, BLACK;
  }
